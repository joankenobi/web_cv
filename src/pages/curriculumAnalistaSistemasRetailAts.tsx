...
const encabezado = {
  name: 'Joan Blanco',
  job: 'Programador / Analista de Sistemas',
}
...
const summary = {
  ...
  text: Summaries.AnalistaSistemasRetail,
}
...
// Skills categorizados para mejor parseo ATS — alineados al perfil Analista de Sistemas Retail
const skillCategories = [
  {
    category: "Lenguajes de Programación",
    items: [Allskills.Python.name, Allskills.JavaScript.name, Allskills.TypeScript.name, Allskills.Java.name]
  },
  {
    category: "Bases de Datos",
    items: [Allskills.SQL.name, Allskills.NoSQL.name, "SQL Server", "PostgreSQL", "MySQL"]
  },
  {
    category: "Desarrollo y Análisis",
    items: [Allskills.RESTfulAPIs.name, Allskills.React.name, "Dashboards", "Análisis de Datos", "Inteligencia Artificial"]
  },
  {
    category: "Herramientas y Control de Versiones",
    items: [Allskills.Git.name, "Postman", Allskills.Docker.name, "Power BI", "VS Code"]
  },
  {
    category: "Metodologías",
    items: [Allskills.AgileScrum.name, Allskills.Microservicios.name]
  },
]
...
export function CurriculumAnalistaSistemasRetailAts() {
  return (
