...
const encabezado = {
  name: 'Joan Blanco',
  job: 'Desarrollador FullStack | Ingeniero de Software',
}
...
export function CurriculumFullStackGaliciaNextJavaAts() {
  return (
    <article className="ats-cv max-w-[800px] mx-auto py-6 px-10 bg-white text-black font-sans text-[11pt] leading-relaxed">
      ...
      <section className="mb-4">
        ...
        {workExperience.text.map((item, index) => {
          // Separar empresa y fechas del campo duration "Empresa | Fechas"
